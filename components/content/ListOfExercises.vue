    ...
    <section class="h-screen overflow-auto bg-primary-50 p-10 dark:bg-secondary-900">
        ...
        text-lg 
            ...
            <div class="p-4 max-w-2xl">
                <p>
                    “Saarluse kompassi” lugude lõpus on küsimusi, mille üle omaette või rühmas arutleda. Siin on ülesanded, saarluse uurimise teod - märka, mõtesta, märgi üles, mängi mõttemänge -, mis kutsuvad loovalt mõtlema, kujutlusvõimet lendu laskma, teisisõnu vaimselt ja füüsiliselt uitama ehk ennast ja ümbritsevat jälgima, infot koguma, sortima, (läbi) kirjutama, sirgeldama. Tegude tulemusi saab esitleda, võrrelda ja üldistada paari- või rühmaaruteludes, väitlusringis, kasutada intervjuudes, et mängida mõttemänge, milline võiks tegutseja enda või Saaremaa elu olla tulevikus: mida hoida, mida muuta, mida uut tuua.
                </p>
                <p>
