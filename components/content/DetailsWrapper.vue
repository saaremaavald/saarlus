<script setup>
    defineProps({
        ...
        icon: {
            type: String,
            default: "icon-park-outline:communication"
        }
    });
</script>

<template>
    <details class="my-4 py-4" :open="open ? true : false">
        <summary class="flex items-baseline gap-4 text-2xl font-Special leading-none tracking-tight font-bold text-secondary-800 dark:text-secondary-200">
        ...
        <div class="pl-4 mt-6 leading-normal text-md border-l border-grey dark:border-l-secondary-600">
            <slot></slot>
        </div>
    </details>
</template>
