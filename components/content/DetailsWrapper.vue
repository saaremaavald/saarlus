...
<template>
    <details class="my-4 py-4" :open="open ? true : false">
        <summary class="flex items-center gap-4 text-2xl font-Special leading-none tracking-tight font-bold text-saarlus-700">
            <Icon :name="icon" class="text-2xl" />{{summary}} 
        ...
        <div class="pl-4 leading-normal text-md border-l border-grey">
            <slot></slot>
        </div>
    </details>
</template>
